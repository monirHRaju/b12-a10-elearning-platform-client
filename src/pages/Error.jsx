...
const Error = () => {
    return (
        <div className='flex justify-center items-center flex-col'>
            ...
            <h1 className='text-4xl font-black text-secondary my-10'>oops! Page Not Found</h1>
            <Link to={'/'} className='btn btn-primary text-2xl'> <FaArrowLeft></FaArrowLeft> Back to Homepage</Link>
        </div>
    );
};
